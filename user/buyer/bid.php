...
?>
  ...
  <!-- Slide Show  -->
   ...
   <?php     include("../../connect.php");
                                                              ...
                                                              $run1=mysqli_query($conn,"update item set itemstatus='Not Available' where itemid='$itemid'");  ?>
							document.getElementById("bok").style.display='none';
                                           ...
                                           if(i==0)
                                            {
                                              <?php     $conn = mysqli_connect("localhost","id1123191_nitket","id1123191_nitket","id1123191_nitket");
                                                        $itemid=$_SESSION['itemid'];
                                                        $run1=mysqli_query($conn,"update item set itemstatus='Available' where itemid='$itemid'");
                                                         ?>
                                              }
                                          i=1;
	...
	<div id="countdown"></div></th>
				...
				<input id="bid1" type="text" name="amt" pattern="\d{1,10}"></br>
                                <input id="bid3" type="submit" value="Place Bid" name="sub">
