...
{ 
	 ...
	 if($run)
     {
	 $run1=mysqli_query($conn,"update item set itemstatus='Bid Created' where itemid='$itemid'"); //function to update item status into item  table after creating a bid perform a query against the db.
